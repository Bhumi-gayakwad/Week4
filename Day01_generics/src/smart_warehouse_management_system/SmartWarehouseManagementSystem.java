...
public class SmartWarehouseManagementSystem {
    public static void main(String[] args) {
        ...
        WarehouseUtilty.listItems(furnitureStorage.getItems());
        ...
        WarehouseUtilty.listItems(electronicStorage.getItems());
        ...
        WarehouseUtilty.listItems(groceryStorage.getItems());
        ...
        WarehouseUtilty.listItems(totalStorageOfAyush.getItems());
